...
#ifndef AUTOLAYOUTSTUDY_SWIFT_H
#define AUTOLAYOUTSTUDY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AutoLayoutStudy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AutoLayoutStudy11AppDelegate")
...
SWIFT_CLASS("_TtC15AutoLayoutStudy10CustomCell")
...
SWIFT_CLASS("_TtC15AutoLayoutStudy13SceneDelegate")
...
SWIFT_CLASS("_TtC15AutoLayoutStudy14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(AutoLayoutStudy)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end


@interface ViewController (SWIFT_EXTENSION(AutoLayoutStudy)) <UITableViewDataSource>
